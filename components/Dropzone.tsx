    ...
    <div
      ...
      className={`
        ...
        ${isDragging 
          ...
          : 'border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800/50 hover:border-orange-400 dark:hover:border-slate-500 hover:bg-slate-50 dark:hover:bg-slate-800 hover:shadow-lg dark:hover:shadow-none'}
    ...
    >
      ...
      <div className="pointer-events-none transform transition-transform duration-300">
        <div className={`
          ...
          ${isDragging ? 'bg-orange-100 dark:bg-orange-500/20 text-orange-600 dark:text-orange-500' : 'bg-slate-100 dark:bg-slate-700 text-slate-400 dark:text-slate-400'}
        `}>
